function dydt = odeInjLockingDrugiProlaz(t,y, Rspsve, n, I,Ab,Aw,Bb,Cb,Cw, Gama, Vtot, Vw, betasp, eps, etainj, q, taubw, tauwb, vg, alpha, m, kc, df, alphaI,  ind, brMod, fitovaniGain,Pin, tspan, injektuj, eta0, h, lambdainj, taup, c0)
P = interp1(tspan, Pin, t);
if(injektuj ==1)
% if(t > 5e-9)
